...
const navItems = [
  ...
  { name: "Radar Diskon", href: "/watchlist", icon: BookmarkCheck },
...
export default function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 z-40 bg-[#090b10]/95 backdrop-blur-xl border-t border-white/[0.08] lg:hidden px-2 py-1.5 shadow-2xl safe-area-bottom">
